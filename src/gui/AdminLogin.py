...
"")
        ...
        self.UserLoginPageButton = QPushButton(self.widget)
        self.UserLoginPageButton.setObjectName(u"UserLoginPageButton")
        self.UserLoginPageButton.setGeometry(QRect(670, 20, 101, 24))
        self.UserLoginPageButton.setStyleSheet(u"QPushButton {\n"
...
"}")
        icon = QIcon()
        icon.addFile(u"icons/user-32.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.UserLoginPageButton.setIcon(icon)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.titleLabel_2.setText(QCoreApplication.translate("Dialog", u"ADMIN LOGIN", None))
        self.UserLoginPageButton.setText(QCoreApplication.translate("Dialog", u"USER", None))
    # retranslateUi
